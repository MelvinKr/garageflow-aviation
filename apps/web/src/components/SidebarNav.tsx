  ...
  return (
    <aside className="w-64 bg-[#1f2a37] text-slate-200 min-h-screen">
      ...
      <nav className="flex flex-col gap-1 p-3 text-sm">
        {[...links, { href: "/reports", label: "Rapports", icon: <ChartIcon /> }, { href: "/reports/ai-llm", label: "Rapport IA (LLM)", icon: <ChartIcon /> }, { href: "/admin/roles", label: "Admin → Rôles", icon: <UsersIcon /> }, { href: "/purchase-orders", label: "PO", icon: <StoreIcon /> }, { href: "/templates", label: "Templates", icon: <WrenchIcon /> }].map((item) => {
